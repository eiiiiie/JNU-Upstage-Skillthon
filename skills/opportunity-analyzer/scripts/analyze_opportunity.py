...
출력 JSON 스키마:
{
  ...
  "strengths": ["string"],
  "gaps": ["string"],
  "checklist": [{"item": "string", "priority": "필수 | 권장 | 선택"}],
  "tips": ["string"]
}

verdict_reason 필수 4가지 관점:
1. 자격 요건 충족 여부 (문서 명시 조건 기준)
2. 사용자 관심/목표와의 부합도
3. 일정·활동 가능 조건의 적합성
4. 정보 부족 또는 불확실성
...
출력:
{
  ...
  "checklist": [
    {"item": "팀원 모집 (1~3명)", "priority": "필수"},
    {"item": "아이디어 기획서 초안 작성 (A4 3매)", "priority": "필수"},
    {"item": "머신러닝 관련 아이디어 구체화", "priority": "권장"}
  ],
  "tips": [
...
출력:
{
  ...
  "checklist": [
    {"item": "환경부 담당자에게 자격 요건 확인", "priority": "필수"},
    {"item": "주중 오프라인 일정 가능 여부 확인", "priority": "필수"},
    {"item": "자기소개서 초안 작성 (확인 후 진행)", "priority": "권장"}
  ],
  "tips": [
